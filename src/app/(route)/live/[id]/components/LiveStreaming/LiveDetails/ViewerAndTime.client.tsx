...
function LiveViewerAndTime({ streamStartTime, viewers }:LiveViewerAndTimeProps) {
  //방송 시작 시간 받아서 가공해 사용할 예정
  //시간 데이터를 아직 모름...

  const a = streamStartTime
  const fakeTime = "02:44:06"
  return (
...
export default LiveViewerAndTime