...
import LiveButton from './LiveDetailsButton.client';
import LiveHashTag from './LiveDetailsHashTags.client';
import LiveNickName from './LiveDetailsNickName.client';
import LiveCategory from './LiveDetailsCategory.client';
import LiveOptionButton from './LiveDetailsOptionButton.client';
import LiveViewerAndTime from './LiveDetailsViewerStats.client';
            ...
            <div id="live-information-details-container" className="break-words break-all">
                ...
                <div id="live-informaiton-details-row" className="mt-[15px] items-start flex w-full">
                    ...
                    <div aria-label='방송 정보' className="self-center flex flex-1 flex-col min-w-0">
                        ...
                        <LiveViewerAndTime viewers={525} startTime={"02:15:06"} />
                    </div>
