...
import LiveButton from '../components/LiveStreaming/LiveDetails/LiveDetailsButton.client'; 
import LiveHashTag from '../components/LiveStreaming/LiveDetails/LiveDetailsHashTags.client'; 
import LiveNickName from '../components/LiveStreaming/LiveDetails/LiveDetailsNickName.client'; 
import LiveCategory from '../components/LiveStreaming/LiveDetails/LiveDetailsCategory.client'; 
import LiveOptionButton from '../components/LiveStreaming/LiveDetails/LiveDetailsOptionButton.client'; 
import LiveDetailsViewerStats from '../components/LiveStreaming/LiveDetails/LiveDetailsViewerStats.client';
...
const LiveDetails = () => {
    const { isWideScreen, isFullscreen, isFullOrWide } = useScreenControl();
