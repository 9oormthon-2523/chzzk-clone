...
const DashBoardButton = (props: DashBoardButtonProps) => {
    ...
    const basicStyle = " box-border w-[130px] min-w-[0px] p-0 h-[40px] font-gothic font-black inline-flex items-center justify-center text-[13px] leading-[18px] relative align-top rounded-[5px] filter hover:brightness-[80%]"
    return (
