...
const Widget3 = () => {
  const list = [
    {
      title: '방송 제목',
      info: '매력적인 제목으로 시청자의 관심을 유도 해보세요. 시청자가 방송을 찾을 때 사용할 만한 키워드를 넣는 것이 좋습니다.',
    },
    {
      title: '카테고리 & 태그',
      info: '시청자가 쉽게 찾을 수 있도록 진행 중인 방송에 대한 카테고리와 태그를 추가하세요.',
    },
    {
      title: '미리보기 이미지',
      info: '진행 중인 방송을 설명할 수 있는 사진을 업로드 하세요. 시청자의 관심을 끄는 이미지가 좋습니다.',
    },
  ];
